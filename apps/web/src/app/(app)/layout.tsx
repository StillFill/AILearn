  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <header className="border-b border-zinc-200 bg-white/80 px-4 py-3 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/80">
        <nav className="mx-auto flex max-w-3xl flex-wrap items-center gap-4 text-sm font-medium">
      ...
      <main className="mx-auto flex w-full max-w-3xl min-h-0 flex-1 flex-col px-4 py-4">{children}</main>
    </div>
  );
}
