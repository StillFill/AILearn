 ...
 */
export const PROMPT_VERSION = "v0.1.2";
...
export function getSystemPrompt(): string {
  return [
    ...
    "Numa única mensagem, evite listar um roteiro inteiro numerado (ex.: vários 'Passo 1, Passo 2…'); prefira uma ideia ou convite de cada vez.",
